...
export default function Nav({toggle,setToggle}) {
  ...
  return (
    <div>
      ...
      <div className={(toggle ? `md:-translate-x-72 ` : `translate-x-72 `)+" duration-500 transform flex flex-col pt-12 absolute md:hidden top-0 right-0 h-full w-2/3 z-40 pr-24 bg-gray-50"}>
